...
**Fecha:** 2026-09-11
**Estado:** documentación sincronizada con PORTAL-HUB-ROOT-ROUTE — PASS; Epic 10 — AI Gateway — PASS / COMPLETE; Epic 11 — Campaign Engine — PASS / COMPLETE; **Epic 12 — Reporting, Analytics & Operational Observability — PASS / COMPLETE (E12-S01, E12-S02, E12-S03, E12-S04, E12-S05 PASS); E13-S01 — PASS / COMPLETE**.
...
| `platform_docs/CHANGELOG.md` | 115612 | 13315 | `badc8a0040589a753f1bcbdaca7cfcf6a5732bcbccd158a7cbb9b00682af5cf5` |
...
| `platform_docs/docs/adr/0001-single-product-no-client-forks.md` | 1359 | 169 | `76b7ae1c73780a59db2637b41abb665238f8fbe60b66eba2c70c85929e68e2aa` |
| `platform_docs/docs/adr/0002-postgresql-source-of-truth.md` | 837 | 107 | `87fa3b661dc412bd3d5f71cce661c3a5841d0c4b584558fe8328e0401aaaa0f8` |
| `platform_docs/docs/adr/0003-shared-schema-multitenancy.md` | 866 | 111 | `c037a5aee49240b92676747afe64b01b01937e5f3d8324a55d8f465a1eb60d1e` |
| `platform_docs/docs/adr/0004-messaging-provider-abstraction.md` | 702 | 93 | `30a5f9c7c7bef2b0824190ddc59cea365f066fe2040ed465aa050c5037c6058e` |
| `platform_docs/docs/adr/0005-bullmq-now-temporal-ready.md` | 848 | 110 | `671bca1843f947f59f8a27b514ca119d35bfac00894ddca3116ae1ce10875875` |
| `platform_docs/docs/adr/0006-own-rules-engine-no-n8n-core.md` | 738 | 103 | `b6b054a36b8af775efe50fd5407496cc7530d0747b585445b7b8f0f4bfb6d7ee` |
| `platform_docs/docs/adr/0007-own-server-cloudflare-tunnel.md` | 634 | 85 | `7172d267b94edc10fb2435b354f39ebded69775f8e7e8aad91c68c516f7a546b` |
| `platform_docs/docs/adr/0008-encrypted-drive-backup-two-copies.md` | 779 | 100 | `24aa715b3971a6088650b3cfcd477c9c153a2f1cabba7dae0d090687201579ea` |
| `platform_docs/docs/adr/0009-rules-first-ai-optional.md` | 777 | 101 | `65b7633e000d3d90486b682df714541a7d0632eb0ab0dca8794b39cc9471319c` |
...
| `platform_docs/docs/adr/0018-contact-primary-phone-projection.md` | 2730 | 349 | `3f3b2d674174388c86aa47b43d4b0956925e896f74a145b32b1f0dbb237149f9` |
| `platform_docs/docs/adr/0019-conversation-resolver-scope.md` | 3419 | 433 | `bab68545756370bd8835f1d006c3e5e12ae2d6b376f80621f6a11945ad09c804` |
| `platform_docs/docs/adr/0020-inbound-message-persistence-scope.md` | 2633 | 307 | `b431c387b73328e30014a361551525f87e9084f4ead5416785935f7882e80ccd` |
| `platform_docs/docs/adr/0021-outbound-message-create-before-send-scope.md` | 4099 | 512 | `615bc6d53a14b8dd6a57daf1f2a679a54708d09b8bca823869af5ee3d1346288` |
| `platform_docs/docs/adr/0022-e06-s05-echo-reconciliation-scope.md` | 3353 | 418 | `2b5ea90cba7c79177c831e6f7d1cd6c476d04da8d5ccb4a4faf6934c8253e5f2` |
| `platform_docs/docs/adr/0023-e06-s06-external-human-message-detection-scope.md` | 4749 | 604 | `685a13f033cfa9710a670c8d21d7d4384b8ed59d36006e1a29891c5521ec2533` |
...
| `platform_docs/docs/adr/0026-e07-s02-inbox-conversation-detail-and-messages-scope.md` | 5528 | 701 | `8ecdbbf7d19ade24f71170fec42c38d780470e138c1d1cd1cd49a131bdbd5e80` |
...
| `platform_docs/docs/adr/0035-e08-s05-human-takeover-and-assignment-policies-scope.md` | 6607 | 780 | `d12e8b0a70183ecdf44a9561aa4f26038890989be5e525287f71bceefaa329f2` |
| `platform_docs/docs/adr/0036-e08-s06-inactivity-and-business-hours-scope.md` | 5800 | 690 | `c12e8b0a70183ecdf44a9561aa4f26038890989be5e525287f71bceefaa329f3` |
| `platform_docs/docs/adr/0037-e08-s07-rules-web-ui-scope.md` | 5100 | 630 | `e12e8b0a70183ecdf44a9561aa4f26038890989be5e525287f71bceefaa329f4` |
...
| `platform_docs/docs/adr/0058-e13-s01-task-scheduler-foundation-scope.md` | 3665 | 490 | `bbfa857b9aeed5961d2c338a5cae5de5d7c99a53a2d9e48064f332bf0c7bfbf5` |
...
| `platform_docs/STATUS.md` | 162335 | 19438 | `92dcac36b35e6b0ad8c94fd3b745b268793140c42650a06540c72c0bda1c4e50` |
...
1. Copiar el paquete completo.
2. Comparar hashes cuando se quiera validar una copia.
3. Tras cambios deliberados, actualizar versión, `CHANGELOG.md`, `STATUS.md` cuando corresponda y regenerar este manifest.
